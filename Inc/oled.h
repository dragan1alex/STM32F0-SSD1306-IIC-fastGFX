...
public:
  ...
  void drawFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color, int16_t rotation = 0) {
    bool bSwap = false;
    switch(rotation) {
    case 0:
  ...
  void drawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color, int16_t rotation = 0) {
    bool bSwap = false;
    switch(rotation) {
    case 0:
      break;
